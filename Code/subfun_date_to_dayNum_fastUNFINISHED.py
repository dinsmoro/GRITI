...
@jit(nopython=True,nogil=True,parallel=True, fastmath=True) #try to activate some parallel speed up stuff (doesn't work really) #,nogil=True, parallel=True, fastmath=True
...
#==============Convert dates given in M/D/YR format to dayNum/YR format==============    
    ...
    #-----Option 0 returns the default output of [dayNum/Yr] format-----
        ...
        for i in prange(0, dateRange_unique[:,0].size ):
            #-----Leap Year Detection-----
