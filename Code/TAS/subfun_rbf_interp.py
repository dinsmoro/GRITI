...
def distance_calc_identical(lat1, long1):
    ...
    # # Numba-free option, slightly slower:
    # sinz = np.sin(lat1);
    # cosz = np.cos(lat1);
...
#     return lu_solve(lu_factor(distance_calc_identical(data_lat, data_long), overwrite_a=True, check_finite=False), -data_orig, trans=0, overwrite_b=True, check_finite=False); #most powerful function call
