...
def GRITI_ISR_Haystack_plot_scargleSet(Zenith_time,Zenith_SNR,Zenith_SNR_hp,Zenith_filtHeight,MISA_time,MISA_SNR,MISA_SNR_hp,MISA_filtHeight,pointAltitude,plot_Period_Lim,dateRange,dateRange_dayNum,dateRange_dayNum_zeroHr,FONT_titleFM,FONT_axisTick,FONT_axisLabelFM):

    Zenith_scargPeriod, Zenith_scargPower, Zenith_scarggf = subfun_lombscargle((Zenith_time - dateRange_dayNum_zeroHr[1])*24 , Zenith_SNR_hp[Zenith_filtHeight,:]); #scargle that data
    Zenith_scargPeriod = Zenith_scargPeriod*60; #min, adjust the period out from hrs to minutes (since hrs goes in)
    
    MISA_scargPeriod, MISA_scargPower, MISA_scarggf = subfun_lombscargle((MISA_time - dateRange_dayNum_zeroHr[1])*24 , MISA_SNR_hp[MISA_filtHeight,:]); #scargle that data
    ...
    #~~~~~~~~~~ ZENITH STUFF ~~~~~~~~~~
    #-----ZENITH SNR at 300km-----
    ax[0,0].plot( (Zenith_time-dateRange_dayNum_zeroHr[1])*24, Zenith_SNR[Zenith_filtHeight,:] ); #plot
    ...
    ax[0,0].set_ylabel('SNR at '+str(pointAltitude)+ ' km',fontproperties=FONT_axisLabelFM); #set the y axis label
    ...
    #-----ZENITH SNR high-passed at 300km-----
    ax[1,0].plot( (Zenith_time-dateRange_dayNum_zeroHr[1])*24, Zenith_SNR_hp[Zenith_filtHeight,:] ); #plot
    
    ax[1,0].set_ylabel('High-pass SNR at '+str(pointAltitude)+ ' km',fontproperties=FONT_axisLabelFM); #set the y axis label
    ...
    #-----ZENITH lomb-scargle of SNR high-passed at 300km-----
    ...
    #~~~~~~~~~~ MISA STUFF ~~~~~~~~~~
    #-----MISA SNR at 300km-----
    ax[0,1].plot( (MISA_time-dateRange_dayNum_zeroHr[1])*24, MISA_SNR[MISA_filtHeight,:] ); #plot
    ...
    ax[0,1].set_ylabel('SNR at '+str(pointAltitude)+ ' km',fontproperties=FONT_axisLabelFM); #set the y axis label
    ...
    #-----MISA SNR high-passed at 300km-----
    ax[1,1].plot( (MISA_time-dateRange_dayNum_zeroHr[1])*24, MISA_SNR_hp[MISA_filtHeight,:] ); #plot
    
    ax[1,1].set_ylabel('High-pass SNR at '+str(pointAltitude)+ ' km',fontproperties=FONT_axisLabelFM); #set the y axis label
    ...
    #-----MISA lomb-scargle of SNR high-passed at 300km-----
