...
def GRITI_combinedPlot_keo_TEC_n_AMPERE_1Dintegration_auroralZone(sTECChunked_anyAngleAvg,TEC_timeUnique,TEC_plotLimValu,colorMap, \
    ...
    ax[1].set_ylabel('Log of '+AMPERE_plot_label,fontproperties=FONT_axisLabelFM); #set the y axis label
    ...
    string_Title = 'Integrated AMPERE '+AMPERE_plot_label_noUnits+' in the entire Nothern Hemisphere ['+str(time_cutout_range_delay)+' hr delay]'; #create mecha title
