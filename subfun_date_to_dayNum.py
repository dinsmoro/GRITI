...
#==============Catch input format issues==============
    if( (dateRange.ndim == 1) & (dateRange.size == 3) ):
        dateRange = dateRange.reshape(1,dateRange.size); #prep for an array because numpy throws a hissy if you have a "vector" and not a "[vector,1] array" lol am I right
    else:
